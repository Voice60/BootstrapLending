...
const Contacts = () => {
  return (
    <section id='contacts' className={`paddingTB130px text-center ${styles.contacts}`}>
      <div className='container-xl text-center text-light'>
        <h1 className='mb-5 text-center title'>Contacts</h1>
      ...
      Ut enim ad minim veniam,</p>
        ...
        <div className={`mx-auto text-end ${styles.formsGroup}`}>
